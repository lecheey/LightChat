...
// если длина последнего блока L (в битах) меньше 448 бит или 56 байт, то нужно дополнить блок на 512 - L бит. Если длина L > 448 бит, то нужно тем же образом дополнить последние и добавить еще один блок (еще 512 бит или 64 байта). 
